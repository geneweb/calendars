    ...
    begin
      object%js
        method makeGregorian day month year =
          Calendars.Unsafe.make ~day ~month ~year ~delta:0 Calendars.Gregorian

        method makeJulian day month year =
          Calendars.Unsafe.make ~day ~month ~year ~delta:0 Calendars.Julian

        method makeFrench day month year =
          Calendars.Unsafe.make ~day ~month ~year ~delta:0 Calendars.French

        method makeHebrew day month year =
          Calendars.Unsafe.make ~day ~month ~year ~delta:0 Calendars.Hebrew
